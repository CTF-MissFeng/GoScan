...
import (
	...
	"github.com/CTF-MissFeng/GoScan/Web/library/util/avcheck"
...
// AvCheck 杀软检测
func (s *serviceUtil) AvCheck(r *model.UtilApiAvCheckReq)string{
...
func (s *serviceUtil) SubDomainAdd(r *model.ScanDomainApiAddReq)error{
...
func (s *serviceUtil) SearchSubDomainManager(page, limit int, search interface{}) *model.UtilSubDomainTaskApiManager{
	var (
...
func (s *serviceUtil) SearchSubDomainShow(page, limit int, cus_name string, search interface{}) *model.ScanSubdomainRes{
	var (
		result []*model.ScanSubdomain
	)
	SearchModel := dao.UtilSubdomainResult.Clone()
...
func (s *serviceUtil) SubDomainDel(r *model.UtilSubdomainTaskDelReq)error{
...
func (s *serviceUtil) SubDomainNSqStats()*model.NsqResInfo{
	jsondata, err := producer.NsqStatsInfo(Gnsq.SubDomainTopic)
	if err != nil {
		return &model.NsqResInfo{Code:0,Msg:"获取nsq消息队列信息失败",Count:0,Data:nil}
	}
...
func (s *serviceUtil) PortScanAdd(r *model.UtilPortScanApiAddReq) (string,error) {
	// 检测待扫描端口 参数值是否正确
...
func (s *serviceUtil) SearchPortManager(page, limit int, search interface{}) *model.UtilPortScanResManager{
	var (
...
func (s *serviceUtil) PortScanNSqStats()*model.NsqResInfo{
...
func (s *serviceUtil) PortScanDel(r *model.UtilSubdomainTaskDelReq)error{
...
func (s *serviceUtil)SearchPortScanShow(page, limit int, task_name string ,search interface{}) *model.UtilPortScanResultRes{
	var (
...
func (s *serviceUtil) PortScanEchartsInfo(TaskName string) *model.UtilPortScanResultResEchartsInfo{
...
func (s *serviceUtil) SearchBanalyzeManager(page, limit int, search interface{}) *model.BanalyzeAPiManager{
	var (
...
func (s *serviceUtil) BanalyzeDelete(r *model.BanalyzeAPiDeteleReq)error{
...
// BanalyzeShow 查看指定指纹
func (s *serviceUtil) BanalyzeShow(r *model.BanalyzeAPiDeteleReq)(string,error){
